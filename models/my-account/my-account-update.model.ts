...
export class MyAccountUpdateRequestModel {
  _id: string;
  name: string;
  lastname_1: string;
  lastname_2: string;
  ...
  role?: string;
  scope?: MyAccountUpdateScope[];
  profile_img?: string;
  rh?: MyAccountUpdateRhModel;
  it?: MyAccountUpdateItModel;
}
